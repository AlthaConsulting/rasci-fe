...
import { countries } from "@altha/_/countries.mock";
import { useStateHistory } from "@altha/core/hooks/use-state-history";
...
export function InputPhone({
  ...
  // const initializeDefaultValue = React.useCallback(() => {
  //   if (value) return value;
  //   return `+${selectedCountry?.phone_code}`;
  // }, [selectedCountry?.phone_code, value]);
  ...
  return (
    <div className={cn("flex gap-2", className)}>
      ...
      <Input
        ...
        id={id}
        placeholder="Phone"
        value={valueProp !== undefined ? valueProp : initializeDefaultValue()}
