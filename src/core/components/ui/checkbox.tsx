  ...
  >
    <CheckboxPrimitive.Indicator
      className={cn(
        ...
        "[&>svg.minus]:data-[state=indeterminate]:block",
        "[&>svg.check]:data-[state=checked]:block"
      )}
    >
      <Minus className="minus hidden -translate-y-px h-4 w-4" />
      <Check className="check hidden -translate-y-px h-4 w-4" />
    </CheckboxPrimitive.Indicator>
  </CheckboxPrimitive.Root>
));
