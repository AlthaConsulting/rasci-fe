...
function Calendar({
  ...
  const _monthsClassName = cn("relative flex -m-2", props.monthsClassName);
        ...
        Nav: ({ className, children, ...props }) => {
          ...
          return (
            <nav className={cn("flex items-center", className)}>
              <Button
                variant="outline"
                className="absolute left-2 top-2 h-7 w-7 bg-transparent p-0 opacity-80 hover:opacity-100"
                type="button"
              ...
              <Button
                variant="outline"
                className="absolute right-2 top-2 h-7 w-7 bg-transparent p-0 opacity-80 hover:opacity-100"
                type="button"
